    ...
    <div id='App'>
      ...
      <div className='center-container'>
        ...
        <Routes>
          ...
          <Route path={"/Board/:task"} element= {<EditTask datApp={datApp} delete={handleDelete} filter={filter} setFilter={setFilter} filterName={filterName} setFilterName={setFilterName} setDatApp={setDatApp}/>}/>
